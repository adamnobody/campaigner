...
**Статус:** план (документация)  
**ADR:** `docs/adr/ADR-0004-canvas-scene-types-and-scene-container.md` (Proposed → Accepted в PR4)  
**Зависит от:** закрытия критичного parity из `docs/plans/0.3.1.x-canvas-parity.md`
