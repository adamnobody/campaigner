...
**Зависит от:** parity PR1–PR3 (**0.3.1.x закрыт** на `testbed-rust`, см. `docs/plans/0.3.1.x-canvas-parity.md`); **PR5+** только после ADR-0004 Accepted
...
**Размер:** M · **Трек:** 0.3.1.x · **Схема:** нет · **Статус:** [x] на `testbed-rust`
