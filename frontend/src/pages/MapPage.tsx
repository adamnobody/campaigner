...
import {
  MARKER_ICONS, MARKER_ICON_ENTRIES, MARKER_COLORS, TERRITORY_COLORS,
  MIN_ZOOM, MAX_ZOOM, ZOOM_SPEED, DRAG_THRESHOLD, PANEL_WIDTH,
  DEFAULT_FORM, sxDivider, sxSectionLabel, sxPanelRoot, sxMapContainer,
